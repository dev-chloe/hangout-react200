...
class R013_ArrowFunction extends Component {
  ...
  Function3() {
    ...
    setTimeout(function() {
      ...
      //TypeError: Cannot read property 'arrowFunc' of undefined
      // 콜백 함수 내부에서 this는 window 객체라서 this로 state 변수에 접근하면 undefind 에러 발생
    }, 100);
  }
  ...
  Function5 = (num1, num2, num3) => {
    ...
    // 콜백 함수에 함수 밖의 this를 bind 해주면, this를 컴포넌트로 사용 가낭하여 state 변수에 접근할 수 있다
    setTimeout(() => {
      console.log(num4 + '. Arrow Callback Function : ' + this.state.arrowFunc);
    }, 100);
    // 콜백 함수에 함수 밖의 this를 bind 해주면, this를 컴포넌트로 사용 가낭하여 state 변수에 접근할 수 있다
